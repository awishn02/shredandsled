var ForumTable = {
	...
	if (posts) {
            $("#forum-table").html("<div class='loading_block'><img src='" + this.loader + "' /></div>");
            $.ajax({
                url: "forum/forum-table",
                type: "POST",
                data: {"posts":posts, "page": page, "total_pages":this.total_pages},
                success: function(htmlresponse){
                    $('#forum-table').html(htmlresponse);
                }
            });
        }
    },
