...
class Zend_Validate_EmailAddress extends Zend_Validate_Abstract
{
    ...
    protected $_messageTemplates = array(
        ...
        self::INVALID_FORMAT     => "not a valid email address in the basic format local-part@hostname",
        self::INVALID_HOSTNAME   => "not a valid hostname",
        self::INVALID_MX_RECORD  => "the domain does not appear to have a valid MX record for the given email address",
        self::INVALID_SEGMENT    => "the domain is not in a routable network segment. The email address should not be resolved from public network",
        self::DOT_ATOM           => "can not be matched against dot-atom format",
        self::QUOTED_STRING      => "can not be matched against quoted-string format",
        self::INVALID_LOCAL_PART => "invalid local part for email address",
        self::LENGTH_EXCEEDED    => "exceeds the allowed length",
    );
